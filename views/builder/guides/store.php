<div class="container">
    ...
    <p class="text-pink">{%store_text-20%}</p>
    <p>{%store_text-21%}</p>
    ...
    <h3 class="m-t-5">{%store_subtitle-6%}</h3>
    ...
    <a href="/builder/apps/features/discount" class="link" target="_blank">{%store_link-2%}</a>

    <p>{%store_text-43%}</p>

    <h3 class="m-t-5">{%store_subtitle-7%}</h3>
    ...
    <a href="/builder/apps/features/shop-delivery" class="link" target="_blank">{%store_link-3%}</a>

    <h3 class="m-t-5">{%store_subtitle-8%}</h3>
    ...
    <a href="/builder/apps/features/job" class="link" target="_blank">{%store_link-4%}</a>

    <h3 class="m-t-5">{%store_subtitle-10%}</h3>
    ...
    <div class="flex-column">
        <a href="/builder/apps/features/social" class="link" target="_blank">{%store_link-7%}</a>
        <a href="/builder/apps/features/reviews" class="link" target="_blank">{%store_link-8%}</a>
        <a href="/builder/apps/features/forms" class="link" target="_blank">{%store_link-9%}</a>
    </div>
