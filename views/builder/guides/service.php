<div class="container">
    ...
    <ul>
        <li>{%service_list-1%}</li>
        <li>{%service_list-2%}</li>
        <li>{%service_list-3%}</li>
        <li>{%service_list-4%}</li>
    </ul>

    <p>{%service_text-3%}</p>

    <ul>
        <li>{%service_list-5%}</li>
        <li>{%service_list-6%}</li>
        <li>{%service_list-7%}</li>
    ...
    <ul>
        <li>{%service_list-9%}</li>
        <li>{%service_list-10%}</li>
        <li>{%service_list-11%}</li>
        <li>{%service_list-12%}</li>
    </ul>
    
    <p class="text-pink">{%service_text-17%}</p>
    <p>{%service_text-18%}</p>
    ...
    <ul>
        <li>{%service_list-13%}</li>
        <li>{%service_list-14%}</li>
        <li>{%service_list-15%}</li>
        <li>{%service_list-16%}</li>
    ...
    <a href="/builder/apps/features/custom-page" class="link" target="_blank">{%service_link-1%}</a>
    ...
    <a href="/builder/apps/features/custom-page" class="link" target="_blank">{%service_link-2%}</a>

    <h3 class="m-t-5">{%service_subtitle-8%}</h3>
    ...
    <h3 class="m-t-5">{%service_subtitle-9%}</h3>
    ...
    <h4 class="text-blue bold">{%service_text-66%}</h4>
    ...
    <h4 class="text-blue bold">{%service_text-71%}</h4>
    ...
    <p>{%service_text-81%}</p>
    <p>{%service_text-82%}</p>
    <p class="p-l-5">{%service_text-83%}</p>
    <p class="p-l-5">{%service_text-84%}</p>
    <p class="p-l-5">{%service_text-85%}</p>
    <p class="p-l-5">{%service_text-86%}</p>
    <p class="p-l-5">{%service_text-87%}</p>
    <p class="p-l-5 text-pink">{%service_text-88%}</p>
    ...
    <h3 class="m-t-5">{%service_subtitle-10%}</h3>
    ...
    <a href="/builder/apps/features/custom-page" class="link" target="_blank">{%service_link-4%}</a>

    <h3 class="m-t-5">{%service_subtitle-11%}</h3>
    ...
    <p>{%service_text-106%}</p>

    <iframe class="video-medium margin-auto m-b-3" width="560" height="315" src="https://www.youtube.com/embed/1JYBZwv3Q9M" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    
    <a href="/builder/apps/features/loyalty-card" class="link" target="_blank">{%service_link-5%}</a>

    <h3 class="m-t-5">{%service_subtitle-12%}</h3>
    ...
    <a href="/builder/apps/features/custom-page" class="link" target="_blank">{%service_link-6%}</a>

    <h3 class="m-t-5">{%service_subtitle-13%}</h3>
    ...
    <h3 class="m-t-5">{%service_subtitle-15%}</h3>

    <p>{%service_text-113%}</p>
    ...
    <h3 class="m-t-5">{%service_subtitle-16%}</h3>

    <p>{%service_text-132%}</p>
    ...
    <a href="/builder/apps/features/push-notifications" class="link" target="_blank">{%service_link-7%}</a>
