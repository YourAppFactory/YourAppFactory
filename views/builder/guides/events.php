<div class="container">
    ...
    <h1 class="center w-100">{%events_main_title%}</h1>
    ...
    <a href="/builder/apps/guides/appindex" class="link" target="_blank">{%events_link-1%}</a>
    ...
    <ul>
        <li>{%events_list-8%}</li>
        <li>{%events_list-9%}</li>
        <li>{%events_list-10%}</li>
        <li>{%events_list-11%}</li>
    ...
    <a href="/builder/apps/features/custom-page" class="link" target="_blank">{%events_link-2%}</a>

    <h3 class="m-t-5">{%events_subtitle-6%}</h3>
    <p>{%events_text-29%}</p>
    <p>{%events_text-30%}</p>
    ...
    <h3 class="m-t-5">{%events_subtitle-7%}</h3>
    <p>{%events_text-31%}</p>
    <p>{%events_text-32%}</p>
    ...
    <a href="/builder/apps/features/calendar" class="link" target="_blank">{%events_link-3%}</a>

    <h3 class="m-t-5">{%events_subtitle-8%}</h3>
    <p>{%events_text-33%}</p>
    <p>{%events_text-34%}</p>
    ...
    <h3 class="m-t-5">{%events_subtitle-11%}</h3>
    <p>{%events_text-38%}</p>
    <p>{%events_text-39%}</p>
    <p>{%events_text-40%}</p>
    ...
    <a href="/builder/apps/features/push-notifications" class="link" target="_blank">{%events_link-5%}</a>

    <h3 class="m-t-5">{%events_subtitle-12%}</h3>
    <p>{%events_text-43%}</p>

    <div class="flex-column">
        <a href="/builder/apps/features/social" class="link" target="_blank">{%events_link-6%}</a>
        <a href="/builder/apps/features/forms" class="link" target="_blank">{%events_link-7%}</a>
        <a href="/builder/apps/features/other" class="link" target="_blank">{%events_link-8%}</a>
    </div>
